...
public class DamageCalculator {
    ...
    public DamageCalculator(Unit u1, Unit u2){
        this.unit1 = u1;
        this.unit2 = u2;

        unit1Stats = new UnitStats(unit1);
        unit2Stats = new UnitStats(unit2);
    }
    ...
    public static class UnitStats {
        ...
        public void calculateDamage(Unit r){
            ...
            if (hasAttack) damageSum = setAttackValuesContent(r, Database.getAppContext().getString(R.string.unit_attack_values), 1);
            if (hasExtraProjectiles) projectileSum = setAttackValuesContent(r, Database.getAppContext().getString(R.string.projectile_attack_values), 2);
            if (hasCharge) chargeSum = setAttackValuesContent(r, Database.getAppContext().getString(R.string.unit_attack_values), 3);
