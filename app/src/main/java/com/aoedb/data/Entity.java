...
public abstract class Entity extends BaseEntity {
    ...
    public EntityElement getAgeElement(){
        return getEntityElement(Database.getAppContext().getString(R.string.entity_age));
    }

    public EntityElement getRequiredTechElement(){
        return getEntityElement(Database.getAppContext().getString(R.string.required_technology));
    }

    public EntityElement getNextUpgradeElement(){
        return getEntityElement(Database.getAppContext().getString(R.string.next_upgrade));
    }
