...
public class UnitListActivity extends ListActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.title_activity_unit);
        setAppBarColor(getColor(R.color.blue_background));
        dataModels = Database.getGroupList(Database.UNIT_GROUPS, sort);
    ...
    public void actionSort(){
        ...
        final String[] items = {getString(R.string.sort_age), getString(R.string.sort_building), getString(R.string.sort_alphabetically)};
