...
public class BuildingListActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.title_activity_building);
        setAppBarColor(getColor(R.color.blue_background));
        dataModels = Database.getGroupList(Database.BUILDING_GROUPS, sort);
    ...
    public void actionSort(){
        ...
        String[] items = {getString(R.string.sort_age), getString(R.string.sort_military_eco), getString(R.string.sort_alphabetically)};
